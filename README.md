...
Slows DK Phase down so that the window to hit K Rool is wider

## Installation
1. Download the latest `slow_dk_phase.nrm` from Releases.
...
The produced mod file is named `slow_dk_phase.nrm`.
